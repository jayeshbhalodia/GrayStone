...
require_once(BASEPATH . 'database/pdo/abstractpdo.php');
require_once(BASEPATH . 'database/pdo/mysqlpdo.php');
require_once(BASEPATH . 'database/pdo/select.inc');
require_once(BASEPATH . 'database/pdo/query.inc');
/* End of file DB.php */
